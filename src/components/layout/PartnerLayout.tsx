...
import { Building, Users, Calendar, BarChart3, Settings, LogOut, Menu, X, LayoutGrid, Megaphone, Star } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      <div className="md:hidden bg-[#0F172A] border-b border-white/10 p-4 flex items-center justify-between sticky top-0 z-50">
        <Link to="/" className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center font-bold text-primary-foreground text-sm">FP</div>
          ...
          >
            <div className="hidden md:flex items-center justify-between mb-12 mt-2">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-primary flex items-center justify-center font-bold text-primary-foreground text-lg">FP</div>
              ...
              <Link to="/partner/settings" onClick={() => setIsMobileOpen(false)}>
                <div
                  className={cn(
                    ...
                    location.pathname === "/partner/settings"
                      ? "bg-primary/10 text-primary border border-primary/20 shadow-[0_0_15px_rgba(34,197,94,0.1)]"
                      : "text-muted-foreground hover:bg-white/10 hover:translate-x-1 hover:text-white"
                  )}
                >
