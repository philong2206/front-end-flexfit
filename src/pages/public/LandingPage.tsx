                ...
                >
                  ...
                  >
                    <div className="h-56 relative overflow-hidden">
                      <img src={resolveFitnessImage(loc.thumbnailUrl)} alt={loc.gymName} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
